      ...
      <div className="flex flex-row h-full w-full rounded-3xl ">
        <div className=" grid grid-rows-5  justify-center items-center font-sans w-1/6 bg-white/80 rounded-l-3xl h-full max-h-screen ">
          <div className=" flex flex-col w-full h-full justify-center items-center">
            <img className="h-[75px] top-2" src={BDULogo} alt="BDULOGO" />
          </div>
          <div className="w-full h-full grid grid-rows-6 gap-5 row-span-3">
            <NavLink
              to="/FacHome"
              className=" justify-start flex gap-3 text-center rounded-lg items-center p-2  text-black hover:shadow-md  hover:bg-[#65dfc9]  transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-7 h-7 hover:cursor-pointer hover:underline-offset-8 hover:underline"
              >
          ...
          <div className=" grid grid-cols-none w-full h-full justify-center items-center">
            <button
              className=" justify-start flex gap-3  text-center rounded-lg items-center p-2 hover:shadow-md hover:cursor-pointer hover:bg-[#65dfc9]  transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"
            ...
            >
              ...
              <label className="text-lg text-black font-medium hover:cursor-pointer ">
                Logout
              </label>
            </button>
          </div>
